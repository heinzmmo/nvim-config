return {
  ...
  config = function()
    ...
    local servers = {
      -- C/Cpp
      clangd = {},
      -- Python: Basedpyright für Type-Checking + Intellisense (kein Formatierung)
      basedpyright = {
        settings = {
          basedpyright = {
            analysis = {
              autoSearchPaths = true,
              diagnosticMode = "openFilesOnly", -- oder "workspace" für vollständige Analyse
        ...
        -- Auch auf LSP-Level deaktivieren
      ...
      -- Ruff nur für Linting (kein Autoformatting)
      ruff = {
        init_options = {
          settings = {
            args = {
              "--line-length=88",
              "--select=E,W,F,I,N,UP,B,A,C4,ICN,PIE,PT,RET,SIM,ARG,PL,RUF",
            },
          },
        },
        -- Deaktiviere Formatierung
        settings = {
          format = {
            enable = false,
          },
